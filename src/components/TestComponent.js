...
const AddAccounts = () => {
  ...
  const wizardFormSubmit = (e) => {
    ...
    return (
        <div className="grid">
            <div className="card">
                <b>Try our New Account Wizard, or continue below</b>&nbsp;&nbsp;&nbsp;&nbsp;
                <Button label="Start Wizard" icon="pi pi-bolt" className="p-button-sm" onClick={() => onClickDialog('displayBasic')}></Button>
